...
(** val list_dec_obligation_2 :
    'a1 list -> ('a1 -> __ -> 'a1 -> bool) -> 'a1 list -> 'a1 -> 'a1 list -> ('a1 list ->
    bool) -> bool **)
...
| [] -> ([], [])
| p :: tl ->
  let (hd1, hd2) = p in let (tl1, tl2) = unzip tl in ((hd1 :: tl1), (hd2 :: tl2))
...
(** val term_recursion_func :
    (term, (__, (char list -> __, char list -> term list -> (term -> __ -> __) -> __)
    sigT) sigT) sigT -> __ **)
...
(** val term_recursion :
    term -> (char list -> 'a1) -> (char list -> term list -> (term -> __ -> 'a1) -> 'a1)
    -> 'a1 **)
